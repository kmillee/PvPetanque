...
public class SandFriction3 : MonoBehaviour
{
    ...
    private void HandleGroundCollision(Collision other)
    {
        ...
        float randomFactor = maxDepthFromImpact;
    ...
    private void HandleOtherCollision(Collision other)
    {
        ...
        float angleFactor = angleToDislogement.Evaluate((impactAngle + 1f) * 0.5f);
        ...
        float d = maxDislogement * angleFactor * impulseFactor;
